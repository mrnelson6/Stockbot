...
def main() -> int:
    ...
    parser.add_argument("--deploy-min", type=float, default=0.2, help="Min fraction of cash deployed per event")
    parser.add_argument("--deploy-max", type=float, default=0.8, help="Max fraction of cash deployed per event")
